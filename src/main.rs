...
impl Level {
    ...
    fn add_object(&mut self, x: usize, y: usize, object: Object) {
        self.objects_with_locations.push(ObjectWithLocation {
            x,
            y,
            object,
        })
    ...
    fn print(&self) {
        ...
        for object_with_location in &self.objects_with_locations {
            characters[object_with_location.x][object_with_location.y] = get_printable_character(&object_with_location.object);
        }
