...
pub fn element_to_unicode(element: Option<&Element>) -> &str {
    match element {
        ...
        Some(Element::Text(Text::Noun(Noun::LAVA))) => return "La",
        Some(Element::Text(Text::Noun(Noun::KEY))) => return "Ke",
        Some(Element::Text(Text::Noun(Noun::DOOR))) => return "Do",
        ...
        Some(Element::Text(Text::Adjective(Adjective::OPEN))) => return "Op",
        Some(Element::Text(Text::Adjective(Adjective::SHUT))) => return "Cl",
        None => return "..",
    };
}
...
pub fn unicode_to_element(chars: &str) -> Option<Element> {
    match chars {
        ...
        "La" => Some(Element::Text(Text::Noun(Noun::LAVA))),
        "Ke" => Some(Element::Text(Text::Noun(Noun::KEY))),
        "Do" => Some(Element::Text(Text::Noun(Noun::DOOR))),
        ...
        "Op" => Some(Element::Text(Text::Adjective(Adjective::OPEN))),
        "Cl" => Some(Element::Text(Text::Adjective(Adjective::SHUT))),
        ".." => None,
